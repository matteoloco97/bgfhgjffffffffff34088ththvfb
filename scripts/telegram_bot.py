...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        ...
        "• 🌐 Usa il web con /web <query> (motore avanzato + percorso veloce per meteo/prezzi/risultati)\n"
...
if __name__ == "__main__":
    ...
    log.info("🤖 Avvio Telegram Bot (LLM-only chat | web manuale avanzato + fast live) | polling")
