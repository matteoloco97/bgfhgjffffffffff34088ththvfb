...
def _insert_group(group_name: str, facts: list[dict]) -> int:
    """
    Inserisce una lista di facts in Chroma usando add_fact(subject, value, tags).
    """
    inserted = 0
    for f in facts:
        subject = f["subject"].strip()
        value = f["value"].strip()
        tags = f.get("tags") or [group_name]

        # add_fact(subject, value, tags)
        add_fact(subject, value, tags)
        inserted += 1
    return inserted
...
def main() -> None:
    ...
    jarvis_core = [
        ...
        },
        {
            ...
            "tags": ["jarvis", "architecture", "verticals"],
        },
        {
        ...
        },
        {
            ...
            "tags": ["jarvis", "persona", "style"],
        },
        {
            "subject": "jarvis_tools_scope",
            "value": (
                "Jarvis deve integrare strumenti esterni come: web search, code execution, calendari, promemoria, "
                "email/file e altri tool personali, per agire come hub centrale dell'ecosistema digitale di Matteo."
            ),
            "tags": ["jarvis", "tools", "scope"],
        },
    ]
    ...
    infra_gpu = [
        ...
        },
        {
            ...
            "tags": ["infra", "gpu", "context"],
        },
        {
            "subject": "gpu_cpu_tunnel",
            "value": (
                "La comunicazione tra CPU Contabo e GPU remota avviene tramite tunnel SSH inverso sulla porta 9011. "
                "Il nodo GPU ascolta su 127.0.0.1:8001 e il tunnel espone il servizio sul nodo CPU come 127.0.0.1:9011."
            ),
            "tags": ["infra", "network", "tunnel"],
        },
        {
    ...
    memory_arch = [
        {
            ...
            "tags": ["memory", "chroma", "collections"],
        },
        {
    ...
    quantum_edge = [
        {
            ...
            "value": (
                ...
                "per backup, dataset e knowledge dell'ecosistema Quantum. Le GPU sono trattate come motore "
                "cognitivo temporaneo, mentre Wasabi è il cervello storico persistente."
            ),
            "tags": ["quantum", "storage", "wasabi"],
        },
        {
            ...
            "tags": ["quantum", "edge_ai", "vision"],
        },
        {
            "subject": "quantum_agents_architecture",
            "value": (
                "L'architettura prevede un set di agenti modulari: Telegram Bot, Flush Cache, Backup, Restore, "
            ...
            "tags": ["quantum", "agents", "architecture"],
        },
        {
    ...
    routing = [
        ...
        },
        {
            ...
            "tags": ["routing", "web_search", "live_data"],
        },
    ]
