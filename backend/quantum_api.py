...
BUILD_SIGNATURE = "smart-intent-2025-11-10+env-safe+lazy-semcache+token-budget+summarize-q+no-error-user+feedback-toggle+web-search-endpoint+meta-override+zero-web-guard+no-generic-fallback+parallel-fetch-v1+validator+analytics+guard-relax+warm-harden+explain-guard+analytics-endpoints+web-minicache-endpoints"
...
async def _web_search_pipeline(q:str, src:str, sid:str, k:int, nsum:int)->Dict:
    ...
    # Query "live" → niente LLM, risposta breve + fonti + nota
    summary=""
    note=None
