...
def _ddg_pair_results_and_snippets(html_text: str) -> List[Dict[str, str]]:
    ...
    - trova <a class="result__a">...</a>
    - associa il primo snippet successivo (result__snippet o result__snippet js-result-snippet)
    """
    out: List[Dict[str, str]] = []
    # tutte le occorrenze del link risultato
    link_patts = [
...
def search(query: str, num: int = 8) -> List[Dict[str, str]]:
    ...
    if len(results) >= num:
        ...
        _cache_set(q, num, norm); return norm
